...
class Speedometer : public QQuickPaintedItem
{
    ...
    Q_PROPERTY(QColor speedColor READ getSpeedColor WRITE setSpeedColor NOTIFY speedColorChanged)
...
public:
    ...
    void    setSpeedColor(QColor speedColor);
